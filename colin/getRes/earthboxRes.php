<html>
<head>
<title>birdrockRes</title>
</head>
<body>
<b>birdrockRes</b><br><br>
...
function earthboxRes($filePath,$twoWeekPeriods)
{
...
earthboxRes1($startDate,$twoWeekPeriods,$filePath);
}

function earthboxRes1($startDate,$twoWeekPeriods,$filePath)
{
